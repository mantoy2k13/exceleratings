...
<!--    <link href="https://fonts.googleapis.com/css?family=Roboto:regular,bold,italic,thin,light,bolditalic,black,medium&amp;lang=en" rel="stylesheet">-->
    ...
    <script>
$(function() {
  $('.form-group').on('keydown', '#user_phone', function(e){-1!==$.inArray(e.keyCode,[46,8,9,27,13,110,190])||/65|67|86|88/.test(e.keyCode)&&(!0===e.ctrlKey||!0===e.metaKey)||35<=e.keyCode&&40>=e.keyCode||(e.shiftKey||48>e.keyCode||57<e.keyCode)&&(96>e.keyCode||105<e.keyCode)&&e.preventDefault()});
})
    </script>
                ...
                <div class="card-block">
                    ...
                    <form action="login/checkUser" method="post">
                        <div class="form-group">
                            <input id="user_name" type="text" name="user_name" class="form-control" placeholder="User Name" required>
                        </div>
                        <div class="form-group">
                            <input id="password" type="password" name="user_pass" class="form-control" placeholder="Password" required>
                            <a href="profile/forget_something" class="pull-xs-right">
                                <small>Forgot?</small>
                            </a>
            ...
            <div class="card">
                <div class="card-block center">
                    ...
                    <form action="profile/regUser" method="post">
                        ...
                        <div class="form-group">
                            <input name="user_phone" id="user_phone" type="text" class="form-control" placeholder="XXX-XXX-XXXX" minlength="10" maxlength="10" required>
                        </div>
