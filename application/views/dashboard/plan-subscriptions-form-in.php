   ...
   <div class="col-md-8">
      <div class="card">
         <div class="card-header with-border wow bounceInLeft">
            <h2 class="card-title card-box">Enrollment</h2>
         </div>
         <hr>
...
<?php } ?>
   ...
   <div class="col-md-4">
      <br>
      <div class="panel panel-bronze panel-default wow flipInX">
         ...
         <div class="panel-footer">
            <a href="<?= base_url('dashboard/page/plan_subscription_form?plan=bronze') ?>" class="btn-block btn btn-orange" role="button">Subscribe</a>
         </div>
      </div>
      <div class="panel panel-silver panel-default wow flipInX">
         <div class="panel-heading">
            <h3 class="panel-title">
         ...
         <div class="panel-footer">
            <a href="<?= base_url('dashboard/page/plan_subscription_form?plan=silver') ?>" class="btn btn-orange btn-block" role="button">Subscribe</a>
         </div>
      </div>
      <div class="panel panel-gold wow panel-default flipInX">
         <div class="panel-heading">
            <h3 class="panel-title">
         ...
         <div class="panel-footer">
            <a href="<?= base_url('dashboard/page/plan_subscription_form?plan=gold') ?>" class="btn-block btn btn-orange" role="button">Subscribe</a>
         </div>
      </div>
   </div>
   <!-- /.box -->
