<?php $this->load->view('front/header-pg');?>
        ...
        <section class="module bg-dark-60 about-page-header" data-background="<?php echo base_url('assets/front/'); ?>assets/images/about_bg.jpg">
          <div class="container">
            <div class="row">
          ...
          <div class="container">
            ...
            <div class="row">
              <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                <div class="team-item">
                  <div class="team-image"><img src="<?php echo base_url('assets/front/'); ?>assets/images/team-1.jpg" alt="Member Photo"/>
              ...
              <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                <div class="team-item">
                  <div class="team-image"><img src="<?php echo base_url('assets/front/'); ?>assets/images/team-2.jpg" alt="Member Photo"/>
                    <div class="team-detail">
              ...
              <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                <div class="team-item">
                  <div class="team-image"><img src="<?php echo base_url('assets/front/'); ?>assets/images/team-3.jpg" alt="Member Photo"/>
                    <div class="team-detail">
              ...
              <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                <div class="team-item">
                  <div class="team-image"><img src="<?php echo base_url('assets/front/'); ?>assets/images/team-4.jpg" alt="Member Photo"/>
                    <div class="team-detail">
          ...
          <div class="container">
            ...
            <div class="row">
              <div class="col-md-6 col-lg-6 hidden-xs hidden-sm">
                <div class="alt-services-image align-center"><img src="<?php echo base_url('assets/front/'); ?>assets/images/promo.png" alt="Feature Image"></div>
              </div>
