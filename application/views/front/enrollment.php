					...
					<div class="card-body" id="cat_add_form">
						...
						<form action="" id="enrollment_form" method="POST" >
						  <div class="row wow bounceInRight">
								<div class="btn row" data-toggle="buttons">
									<div class="btn-group">
							...
							<div class="row form-row wow bounceInLeft">
							...
							<div class="row form-row wow bounceInRight">
								 <div class="form-group col-md-6">
							...
							<div class="form-group row">
							 ...
							 <div class="col-sm-6 col-form-label font-weight-bold" style="font-weight:bold;"><br>TOTAL:</div>
							 <div class="col-sm-6">
								<div class="input-group">
									<span class="input-group-addon" id="basic-addon1" style="font-weight:bold;">$</span>
									<input type="text" class="form-control font-weight-bold text-right" id="total_amount" name="total_amount" placeholder="#" value="<?=$setup_fee + $service_fee_month2month + $service_fee_yearcotract + $additional_services?>" readonly style="font-weight:bold;">
								</div>
							 </div>
						  </div>
								<hr>
							...
							<p class="font-weight-bold text-center bg-dark p-3 mb-2">Without your permission, your client information is NEVER shared – PERIOD!</p>
							<hr>
