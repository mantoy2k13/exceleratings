								...
								<div class="btn" data-toggle="buttons">
									<div class="btn-group">
										<label class="btn btn-info" title="Anser get by Yes/No options">
											<input type="radio" value="free" name="answer_option" id="option1" <?php if( isset($_GET['plan']) ){ if( $_GET['plan'] == 'basic' ){ echo 'selected'; } } ?>> 
											Basic Plan
										</label>
									
										<label class="btn btn-info" title="Answer get by 1 to 10 reviewing options">
											<input type="radio" value="silver" name="answer_option" id="option3" <?php if( isset($_GET['plan']) ){ if( $_GET['plan'] == 'silver' ){ echo 'selected'; } } ?>>
											Basic Plus Plan (Silver)
										</label>
									
										<label class="btn btn-info" title="Answer get by 1 to 10 reviewing options">
											<input type="radio" value="gold" name="answer_option" id="option3" <?php if( isset($_GET['plan']) ){ if( $_GET['plan'] == 'gold' ){ echo 'selected'; } } ?>>
											Premium Plan (Golden)
										</label>
									</div>
								</div>
						  ...
						  <div class="form-group row wow bounceInLeft">
							 ...
							 <div class="col-sm-6">
								<div class="input-group">
									...
									<input type="number" class="form-control text-right" id="inputEmail3" placeholder="#" readonly >
								</div>
							 </div>
							 ...
							 <div class="col-sm-6">
								<div class="input-group">
									...
									<input type="number" class="form-control form-control-lg font-weight-bold text-right" id="total_amount" placeholder="#" readonly >
								</div>
							 </div>
						  </div>
