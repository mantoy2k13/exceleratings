...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2018 at 01:20 PM
...
(2, 'How was our customer service?', 'rev_1_10', 1, 0, 1),
(3, 'How was your individual experience while you were here?', 'rev_1_10', 15, 0, 1),
(4, 'Would you refer your friends or family here?', 'rev_1_10', 2, 0, 1),
(5, 'What was the quality of our Doctor\'s service?', 'rev_1_10', 3, 0, 1),
(6, 'What was the quality of the medical treatment you received?', 'rev_1_10', 4, 0, 1),
(7, 'How would you rate the cleanliness of our facility?', 'rev_1_10', 5, 0, 1),
(8, 'How likely is it that you will return for a visit to our practice?', 'rev_1_10', 0, 2, 1),
(9, 'Do you have additional comments or concerns?', 'rev_1_10', 7, 0, 1),
(12, 'Nonummy sollicitudin aliqua morbi sodales tempora voluptate!', 'yes_no', 14, 0, 0),
(14, 'Rquam et. Nonummy sollicitudin aliqua morbi sodales tempora voluptate!', 'rev_1_10', 2, 2, 0),
(15, 'Eiam optio, platea, sodales, totam dolore, quam esse nunc ipsum senectus faucibus', 'rev_1_10', 13, 0, 0),
(16, 'Review question add form\r\n', 'rev_1_10', 10, 0, 0),
(17, 'Lacus eleifend consectetuer gravida hac hac auctor pede ullam in quia class. Eos ad, ullam? ', 'rev_1_10', 9, 0, 0),
(18, 'New question, Lorem ipsum doror (Dummy text)', 'rev_1_10', 11, 0, 0),
(19, 'Vestibulum fugit congue porta dui anim mollis', 'yes_no', 8, 0, 0),
(20, 'Review question add form', 'rev_1_10', 1, 2, 1);
...
INSERT INTO `user_profile` (`uid`, `fullname`, `fullname_contact`, `phone`, `alt_name_client_contact`, `alt_phone`, `alt_email`, `tablet_needed`, `tablet_so_how_many`, `service_location`, `start_date_of_contract`, `about`, `profilpic`, `pos_rdr_url_yelp`, `pos_rdr_url_google`, `pos_rdr_url_facebook`, `pos_rdr_url_trip_advisor`) VALUES
(2, 'Afdsfds  reyt', '', '', '', '', '', 0, 0, '', '', 'About', 'Screenshot_13.jpg', '', 'dsfsdfwrfs', 'sdf dsfds', ''),
...
(1, 'Super Admin', '', '', '', '', '', 0, 0, '', '', 'About AboutAboutAbout', 'no-image-icon1.png', '', '', '', ''),
