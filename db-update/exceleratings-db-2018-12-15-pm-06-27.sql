...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 15, 2018 at 01:26 PM
...
--
-- Table structure for table `question_pages`
--
...
--
-- Dumping data for table `question_pages`
--

INSERT INTO `question_pages` (`id`, `pg_title`, `userid`, `inserted_at`) VALUES
...
--
-- Indexes for table `question_pages`
--
...
--
-- AUTO_INCREMENT for table `question_pages`
--
ALTER TABLE `question_pages`
