...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 31, 2018 at 06:39 AM
...
(10, 'Page Title  dfdf', 2, '0000-00-00 00:00:00');
...
INSERT INTO `rev_questions` (`qid`, `question`, `answer_option`, `shorting`, `userid`, `service_category`, `status`) VALUES
(1, 'How was your visit here overall?', 'rev_1_10', 2, 1, 2, 1),
(2, 'How was our customer service?', 'rev_1_10', 5, 1, 1, 1),
(3, 'How was your individual experience while you were here?', 'rev_1_10', 18, 1, 3, 1),
(4, 'Would you refer your friends or family here?', 'rev_1_10', 8, 1, 2, 0),
(5, 'What was the quality of our Doctor\'s service?', 'rev_1_10', 7, 1, 3, 1),
(6, 'What was the quality of the medical treatment you received?', 'rev_1_10', 9, 1, 1, 1),
(7, 'How would you rate the cleanliness of our facility?', 'rev_1_10', 10, 1, 3, 1),
(8, 'How likely is it that you will return for a visit to our practice?', 'rev_1_10', 3, 2, 0, 1),
(9, 'Do you have additional comments or concerns?', 'rev_1_10', 11, 1, 1, 1),
(12, 'Nonummy sollicitudin aliqua morbi sodales tempora voluptate!', 'yes_no', 17, 1, 2, 1),
(14, 'Rquam et. Nonummy sollicitudin aliqua morbi sodales tempora voluptate!', 'rev_1_10', 5, 2, 0, 0),
(15, 'Eiam optio, platea, sodales, totam dolore, quam esse nunc ipsum senectus faucibus', 'rev_1_10', 16, 1, 2, 0),
(16, 'Review question add form\r\n', 'rev_1_10', 14, 1, 2, 0),
(17, 'Lacus eleifend consectetuer gravida hac hac auctor pede ullam in quia class. Eos ad, ullam? ', 'rev_1_10', 13, 1, 3, 0),
(18, 'New question, Lorem ipsum doror (Dummy text)', 'rev_1_10', 15, 0, 0, 0),
(19, 'Vestibulum fugit congue porta dui anim mollis', 'yes_no', 12, 1, 1, 0),
(20, 'Review question add form', 'rev_1_10', 4, 2, 0, 1),
(21, 'Review question add form', 'rev_1_10', 1, 3, 0, 1),
(22, ' question add form The Question', 'rev_1_10', 0, 3, 0, 1),
(23, 'Aenean, molestie, amet quia. Aspernatur odit venenatis mauris consequatur laudantium quas error?', 'rev_1_10', 6, 2, 0, 1),
(24, 'Imperdiet voluptatum per, mollis quibusdam! Tempor', 'rev_1_10', 2, 2, 0, 1),
(25, 'Penatibus porttitor illum, enim', 'rev_1_10', 1, 2, 0, 1),
(26, 'Sollicitudin dolor illum, reiciendis', 'rev_1_10', 0, 2, 0, 1),
(27, 'Curae faucibus sapien quia aliquid curabitur', 'rev_1_10', -5, 4, 0, 1),
(28, 'Nibh dis, mollis non pharetra eveniet magnis nunc rutrum', 'rev_1_10', -6, 4, 0, 1),
(29, 'Deserunt explicabo quia ultricies nemo', 'rev_1_10', -7, 4, 0, 1),
(30, 'Maecenas elit nascetur ultrices feugiat', 'rev_1_10', -8, 4, 0, 1),
(31, 'estion add form', 'rev_1_10', -9, 2, 0, 1);
...
(1, 'Contractor', 1),
(2, 'Medical', 1),
(3, 'Hospitality (Restaurant/Hotel)', 1);
...
(2, 'gnuser5', 'thomas5@yopmail.com', '202cb962ac59075b964b07152d234b70', 'generaluser', 'gold', 1, NULL, NULL),
...
(5, 'gnuser11', 'thomas12@yopmail.com', '202cb962ac59075b964b07152d234b70', 'generaluser', 'free', 0, NULL, NULL),
(6, 'gnuser52', 'thomas.woodfin162@yopmail.com', '202cb962ac59075b964b07152d234b70', 'generaluser', 'free', 0, NULL, NULL);
